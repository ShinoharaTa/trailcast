...
export const thread: Thread = {
  ...
  checkpoints: [
    {
      id: "cp1",
      text: "京都駅到着！新幹線の中から富士山が見えてテンション上がった。天気も良くて最高のスタート",
      images: [],
      time: "09:00",
      location: "京都駅",
      author: "shino3",
    ...
    {
      id: "cp3",
      text: "祇園の路地裏で見つけた小さなカフェでランチ。湯葉の御膳が美味しかった。店の名前メモし忘れた…次来たとき探せるかな",
      images: [],
      time: "12:00",
      location: "祇園",
      author: "shino3",
    ...
    {
      id: "cp6",
      text: "京都タワーからの夜景を眺めて帰路へ。一日で回りきれないぐらい見どころがあった。桜の時期にまた来よう",
      images: [],
      time: "18:30",
      location: "京都タワー",
      author: "shino3",
...
export const publicThread: Thread = {
  ...
  checkpoints: [
    ...
    {
      id: "pub3",
      text: "二次会のカフェバー。AT Protocolの話で盛り上がった。自作Lexiconの運用どうしてる？って話が面白かった",
      images: [],
      time: "19:30",
      location: "上野カフェバー",
      author: "taro",
    ...
    {
      id: "pub4",
      text: "解散！みんなありがとう。次は夏コミ後にまた集まろう",
      images: [],
      time: "22:00",
      author: "shino3",
      authorAvatar: AVATAR_SHINO3,
...
export const blueskyPosts: BlueskyPost[] = [
  ...
  },
  {
    ...
    text: "東大寺の大仏殿。何度来ても大きさに圧倒される。修学旅行ぶりだけど印象が全然違う",
    images: [],
