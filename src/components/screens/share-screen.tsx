...
export function ShareScreen({ navigate, goBack, params }: NavigationProps) {
  ...
  const { repo, rkey } = threadUri ? parseAtUri(threadUri) : { repo: "", rkey: "" };
      ...
      <div className="rounded-2xl bg-surface-800 p-6 shadow-lg sm:p-8">
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-3">
            <button
              onClick={() => navigate("bsky-crosspost", params)}
